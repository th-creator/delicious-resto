...
<div class="card-transparent bg-transparent mb-0">
    ...
    <div class="card-body p-0 dish-card-vertical">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide  col-md-12 col-lg-6">
                <div class="card card-white dish-card2 index">
                    <div class="card-body ">
                        <div class="d-flex profile-img1">
                            <div class="profile-img31">
                                <img src="{{ asset('images/layouts/17.png') }}" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                <img src="{{ asset('images/layouts/17.png') }}" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                            </div>
                            <div>
                                <span class="text-primary">
                                    <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-1 mt-3 heading-title fw-bolder">Buffy</h6>
                                <p class="mt-2 mb-0 pb-4 iq-calories">180 Calories</p>
                                <p>3 persons</p>
                                <div class="d-flex mt-2">
                                    <span class="text-primary me-4">$12.49</span>
                ...
                <div class="card card-white dish-card2 index">
                    <div class="card-body ">
                        <div class="d-flex profile-img1">
                            <div class="profile-img31">
                                <img src="{{ asset('images/layouts/19.png') }}" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                <img src="{{ asset('images/layouts/19.png') }}" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                            </div>
                            <div>
                                <span class="text-primary">
                                    <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-1 mt-3 heading-title fw-bolder">Coco dish</h6>
            ...
            <div class="swiper-slide col-md-12 col-lg-6">
                <div class="card card-white dish-card2 index">
                    <div class="card-body ">
                        <div class="d-flex profile-img1">
                            <div class="profile-img31">
                                <img src="{{ asset('images/layouts/14.png') }}" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                <img src="{{ asset('images/layouts/14.png') }}" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                            </div>
                            <div>
                                <span class="text-primary">
                                    <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-1 mt-3 heading-title fw-bolder">Vegies</h6>
                                <p class="mt-2 mb-0 pb-4 iq-calories">60 Calories</p>
                                <p>2 persons</p>
                                <div class="d-flex mt-2">
                                    <span class="text-primary me-4">$2.49</span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="24" height="24" rx="12" fill="#EA6A12"/>
                                        <rect x="11.168" y="7" width="1.66667" height="10" rx="0.833333" fill="white"/>
                                        <rect x="7" y="12.834" width="1.66666" height="10" rx="0.833332" transform="rotate(-90 7 12.834)" fill="white"/>
                    ...
                    <div class="card-body ">
                        <div class="d-flex profile-img1">
                            <div class="profile-img31">
                                <img src="{{ asset('images/layouts/20.png') }}" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                <img src="{{ asset('images/layouts/20.png') }}" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                            </div>
                            <div>
                                <span class="text-primary">
                                    <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 class="mb-1 mt-3 heading-title fw-bolder">Hot Chocolate</h6>
                                <p class="mt-2 mb-0 pb-4 iq-calories">120 Calories</p>
                                <p>1 person</p>
                                <div class="d-flex mt-2">
                                    <span class="text-primary me-4">$1.49</span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="24" height="24" rx="12" fill="#EA6A12"/>
                                        <rect x="11.168" y="7" width="1.66667" height="10" rx="0.833333" fill="white"/>
                                        <rect x="7" y="12.834" width="1.66666" height="10" rx="0.833332" transform="rotate(-90 7 12.834)" fill="white"/>
            ...
            <div class="swiper-slide">
                <div class="card card-white dish-card2 index">
                    <div class="card-body ">
                        <div class="d-flex profile-img1">
                            <div class="profile-img31">
                                <img src="{{ asset('images/layouts/18.png') }}" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                <img src="{{ asset('images/layouts/18.png') }}" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                            </div>
                            <div>
                                <span class="text-primary">
                                    <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card-body ">
                        <div class="d-flex profile-img1">
                            <div class="profile-img31">
                                <img src="{{ asset('images/layouts/21.png') }}" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                <img src="{{ asset('images/layouts/21.png') }}" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                            </div>
                            <div>
                                <span class="text-primary">
                                    <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xxl-4">
                <div class="col active">
                    <div class="card card-white dish-card profile-img mb-0 index">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/16.png') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/16.png') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                ...
                <div class="col">
                    <div class="card card-white dish-card profile-img mb-0 index">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/15.png') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/15.png') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                        <div class="card-body menu-image">
                        <h6 class="heading-title fw-bolder mt-4 mb-0">Spaghetti</h6>
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <div class="d-flex align-items-center">
                                    <span class="text-primary fw-bolder me-2">$9.39</span>
                ...
                <div class="col">
                    <div class="card card-white dish-card profile-img mb-0 active">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/14.png') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/14.png') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                        <div class="card-body menu-image">
                ...
                <div class="col">
                    <div class="card card-white dish-card profile-img mb-0 index">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/12.png') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/12.png') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                        <div class="card-body menu-image">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xxl-4">
                <div class="col active">
                    <div class="card card-white dish-card profile-img mb-0 index">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/13.png') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/13.png') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                        <div class="card-body menu-image">
                        <h6 class="heading-title fw-bolder mt-4 mb-0">Chinese Pizza</h6>
                            <div class="card-rating stars-ratings">
                ...
                <div class="col">
                    <div class="card card-white dish-card profile-img mb-0 index">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/images (1).jpeg') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/images (1).jpeg') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                        <div class="card-body menu-image">
                        <h6 class="heading-title fw-bolder mt-4 mb-0">Italian Pizza</h6>
                            <div class="card-rating stars-ratings">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <div class="d-flex align-items-center">
                                    <span class="text-primary fw-bolder me-2">$8.49</span>
                                    <small class="text-decoration-line-through"></small>
                                </div>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect class="circle-1" width="24" height="24" rx="12" fill="currentColor"/>
                ...
                <div class="col">
                    <div class="card card-white dish-card profile-img mb-0">
                        <div class="profile-img21">
                            <img src="{{ asset('images/layouts/11.png') }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                alt="profile-image">
                            <img src="{{ asset('images/layouts/11.png') }}" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                        </div>
                        <div class="card-body menu-image">
                        <h6 class="heading-title fw-bolder mt-4 mb-0">Tomato Pizza</h6>
                            <div class="card-rating stars-ratings">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <div class="d-flex align-items-center">
                                    <span class="text-primary fw-bolder me-2">$3.49</span>
                                    <small class="text-decoration-line-through"></small>
                                </div>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect class="circle-1" width="24" height="24" rx="12" fill="currentColor"/>
                ...
                <div class="col">
                    <div class="card card-white dish-card profile-img mb-0 index">
                        ...
                        <div class="card-body menu-image">
                        <h6 class="heading-title fw-bolder mt-4 mb-0">Pasta dish</h6>
                            <div class="card-rating stars-ratings">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <div class="d-flex align-items-center">
                                    <span class="text-primary fw-bolder me-2">$3.99</span>
                                    <small class="text-decoration-line-through"></small>
                                </div>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect class="circle-1" width="24" height="24" rx="12" fill="currentColor"/>
