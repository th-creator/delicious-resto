...
<head>
    ...
    <!-- Include CSS files here -->
      <title>Delicious | Restaurant Management Admin Template</title>
      ...
      <!-- Custom Css -->
      <link rel="stylesheet" href="{{ asset('css/aprycot.min.css?v=1.0.0') }}">
...
<body class="  "  style="background:url({{ asset('images/dashboard.png') }}') }});    background-attachment: fixed;
          ...
          <aside class="sidebar sidebar-default sidebar-hover sidebar-mini navs-pill-all ">
              <div class="sidebar-header d-flex align-items-center justify-content-start">
                  <a href="/" class="navbar-brand">
                      <!--Logo start-->
                      <div class="logo" style="width: 7rem">
                          <img src="{{ asset('images/favicon.ico') }}" class="img-fluid logo-img" alt="img4" width="80" height="43">
                      ...
                      <ul class="navbar-nav iq-main-menu">
                        ...
                        @if(Auth::user()->role == 'admin' || Auth::user()->role == 'employee')
                          ...
                          <li class="nav-item">
                              ...
                              <ul class="sub-nav collapse" id="sidebar-reservation" data-bs-parent="#sidebar">
                                  <li class="nav-item">
                                      <a class="nav-link " href="{{route('reservations.create')}}">
                                          ...
                                          <i class="sidenav-mini-icon"> A </i>
                                          <span class="item-name">Make a Reservation</span>
                                      </a>
                                  </li>
                                ...
                                @if(Auth::user()->role == 'admin' || Auth::user()->role == 'employee')
                                  <li class="nav-item">
                                      <a class="nav-link " href="/all/reservations">
                                          ...
                                          <i class="sidenav-mini-icon"> A </i>
                                          <span class="item-name">Reservations List</span>
                                      </a>
                                  </li>
                                @else
                                  <li class="nav-item">
    ...
    <footer class="footer">
        <div class="footer-body">
            ...
            <div class="right-panel">
                ©<script>document.write(new Date().getFullYear())</script> Delecious - لــــذيذ , Made with
                ...
                </span> by <a href="https://github.com/th-creator/delicious-resto">OTHMAN + OUSSAMA</a>.
            </div>
        </div>
    </footer>
</body>
